<template>
  <section class="flex flex-wrap items-center gap-3 border-y border-gray-200 py-3 dark:border-dark-700">
		<SearchInput :model-value="draft.query" class="w-full sm:w-56" data-testid="group-query" placeholder="分组名称" @update:model-value="updateQuery" @search="runNow" />
		<Select v-model="draft.platform" class="w-full sm:w-40" data-testid="group-platform" :options="platformOptions" @update:model-value="runNow" />
		<Select v-model="draft.groupStatus" class="w-full sm:w-36" data-testid="group-status" :options="groupStatusOptions" @update:model-value="runNow" />
		<Select :model-value="draft.callStatus || ''" class="w-full sm:w-40" data-testid="group-call-status" :options="callStatusOptions" @update:model-value="updateCallStatus" />
		<Select v-model="draft.range" class="w-full sm:w-36" data-testid="group-range" :options="rangeOptions" @update:model-value="runNow" />
