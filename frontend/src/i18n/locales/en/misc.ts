export default {
  ...
  version: {
    ...
    sourceModeHint: 'Source build, sync upstream and auto-publish conflict-free changes',
    updateNow: 'Sync and Auto-publish',
    updating: 'Syncing and publishing...',
    updateComplete: 'Update Complete',
    updatePrepared: 'Upstream integration branch prepared',
    updatePublished: 'Automatically published to production',
    updateFailed: 'Update Failed',
    updateConflict: 'Upstream merge conflict; publishing stopped',
    ...
    updateConflictCommits: 'Merge base -> upstream commit',
