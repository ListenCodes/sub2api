...
func (h *UserHandler) reportRiskStatusAudit(actorID, userID int64, requestedStatus, beforeStatus, afterStatus, result, reason, failureReason, batchID, requestID string) {
