...
func TestIdentityRolloutRejectsUnknownTransition(t *testing.T) {
	...
	require.True(t, ValidIdentityTransition(IdentityTransitionStage5Composite))
	_, err := NewUpdateService(nil, nil, "0.1.163", "release").PrepareIdentityRollout(context.Background(), "stage6-enforce")
