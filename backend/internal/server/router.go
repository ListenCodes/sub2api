...
func SetupRouter(
	...
	if web.HasEmbeddedFrontend() {
		frontendServer, err := web.NewFrontendServer(settingService) //nolint:staticcheck // embed build can return conditional initialization errors
		if err != nil {                                              //nolint:staticcheck // embed build can return conditional initialization errors
