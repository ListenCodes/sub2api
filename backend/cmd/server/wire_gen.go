...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	adminUserHandler.SetAuthService(authService)
	adminUserHandler.SetRiskControlClient(service.NewRiskControlClientFromEnv())
	authHandler.SetRiskBanHandler(adminUserHandler.ApplyRiskBan)
