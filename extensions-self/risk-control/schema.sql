...
INSERT INTO risk_rules (code, name, description, event_types, enabled, window_seconds, threshold, score, risk_level, action)
VALUES
 ('registration_abuse', '注册滥用', '短时间内重复注册或命中注册风险信号', '["registration_attempt", "registration_success"]', TRUE, 600, 3, 80, 'critical', 'reject_candidate'),
 ('login_failure_burst', '登录失败爆发', '同一账号连续登录失败', '["login_failure"]', TRUE, 600, 5, 70, 'high', 'review'),
 ('api_error_burst', 'API 错误爆发', '同一用户短时间内出现大量 API 错误', '["api_error"]', TRUE, 300, 10, 35, 'medium', 'observe'),
 ('content_risk', '内容风险', '命中内容安全策略', '["content_risk"]', TRUE, 86400, 1, 85, 'high', 'review'),
 ('quota_abuse', '配额滥用', '持续触发配额或计费限制', '["quota_exceeded"]', TRUE, 3600, 5, 55, 'medium', 'review'),
 ('upstream_error', '上游错误', '持续触发上游错误', '["upstream_error"]', TRUE, 600, 8, 25, 'low', 'observe'),
 ('api_request_observation', 'API 请求观察', '保留正常请求基线', '["api_request"]', TRUE, 86400, 1, 0, 'low', 'observe')
